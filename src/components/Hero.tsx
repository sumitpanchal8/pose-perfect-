      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="max-w-3xl mx-auto text-center space-y-4">
          ...
          <p className="text-sm sm:text-base text-zinc-300 max-w-2xl mx-auto leading-relaxed">
            No more awkward hands or stiff posture. Choose who you are, select your photo style (Traditional, Professional, Mirror Selfie, Aesthetic), and match the 60% transparent pose guide directly in your live camera.
          </p>
